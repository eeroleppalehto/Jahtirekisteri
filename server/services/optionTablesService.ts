...
export const getAllAikuinenvasa = async (): Promise<object[]> => {
    const data = await prisma.$queryRawUnsafe<object[]>('SELECT * FROM aikuinenvasa');
    return data;
};
...
export const getAllKasittely = async (): Promise<object[]> => {
    const data = await prisma.$queryRawUnsafe<object[]>('SELECT * FROM kasittely');
    return data;
};
 ...
 */
export const getAllLupa = async (): Promise<object[]> => {
    const data = await prisma.$queryRawUnsafe<object[]>('SELECT * FROM lupa');
    return data;
};
...
export const getAllSukupuoli = async (): Promise<object[]> => {
    const data = await prisma.$queryRawUnsafe<object[]>('SELECT * FROM sukupuoli');
    return data;
};
