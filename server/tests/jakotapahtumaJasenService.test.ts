...
describe('jakotapahtumaJasenService tests', () => {
    ...
    it('should create a new JakotapahtumaJasen', async () => {
        ...
        prismaMock.jakotapahtuma_jasen.create.mockResolvedValue(jakotapahtumaJasenData);
        const result = await createJakotapahtumaJasen(jakotapahtumaJasenData);
    ...
    it('should read a JakotapahtumaJasen by ID', async () => {
        ...
        prismaMock.jakotapahtuma_jasen.findUnique.mockResolvedValue(jakotapahtumaJasenData);
    ...
    it('should update a JakotapahtumaJasen by ID', async () => {
        ...
        prismaMock.jakotapahtuma_jasen.update.mockResolvedValue(updatedJakotapahtumaJasenData);
        const result = await updateJakotapahtumaJasenById(1, updateData);
    ...
    it('should return all JakotapahtumaJasen', async () => {
        ...
        prismaMock.jakotapahtuma_jasen.findMany.mockResolvedValue(allJakotapahtumaJasenData);
