...
describe("jakotapahtumaService tests", () => {
    ...
    it("should create a new Jakotapahtuma", async () => {
        ...
        const result = await createJakotapahtuma({
            ...jakotapahtumaData,
            paiva: jakotapahtumaData.paiva.toISOString(),
        });
    ...
    it("should read a Jakotapahtuma by ID", async () => {
        ...
        prismaMock.jakotapahtuma.findUnique.mockResolvedValue(
            jakotapahtumaData
        );
    ...
    it("should update a Jakotapahtuma by ID", async () => {
        ...
        prismaMock.jakotapahtuma.update.mockResolvedValue(
            updatedJakotapahtumaData
        );
        const result = await updateJakotapahtumaById(1, {
            ...updatedData,
            paiva: updatedData.paiva.toISOString(),
        });
    ...
    it("should return all Jakotapahtumat", async () => {
        ...
        prismaMock.jakotapahtuma.findMany.mockResolvedValue(
            allJakotapahtumatData
        );
