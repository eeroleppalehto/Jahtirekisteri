...
-- Started on 2023-03-07 20:12:50
...
--
-- TOC entry 3611 (class 1262 OID 29538)
-- Name: metsastys_schema; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE metsastys_schema WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'Finnish_Finland.1252';


ALTER DATABASE metsastys_schema OWNER TO postgres;

\connect metsastys_schema
...
-- Completed on 2023-03-07 20:12:51
